...
class InputSimulator:
    ...
    def __init__(self):
        ...
        if self.input_method == 'pynput' or self.input_method == 'clipboard':
    ...
    def _typewrite_clipboard(self, text):
        """
        Paste text via clipboard (Ctrl+V). Robust for non-ASCII characters
        like ß, ä, ö, ü on Windows where pynput per-char typing breaks
        multibyte UTF-8.
        """
        try:
